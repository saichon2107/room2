...
<html lang="en">
    ...
    <body>
        ...
        include_once('header.php');
            ...
            ?>
            <form action="inputlistinsert.php" method="GET">
                ...
                <div class="row mb-3 ">
                    <label for="j_ser" class="col-sm-2 col-form-label">จำนวนผุ้พัก</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" id="j_ser"
                            name="j_ser" placeholder="จำนวนผุ้พัก">
                    </div>
                </div>
                <div class="row mb-3 ">
                    ...
                    <div class="col-sm-6">
                        ...
                        <option selected>เลือกห้องพัก</option>
