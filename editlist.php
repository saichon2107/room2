        ...
        <div class="container ">
            ...
            <form action="updateser.php" method="GET">
                <div class="row mb-3 mt-3 fs-4">
                    <label for="id_ser" class="col-sm-2 col-form-label">รหัส</label>
                    <div class="col-6">
                        <input type="text" class="form-control" id="id_ser"
                            name="id_ser" readonly placeholder="รหัส" value="<?php echo $id; ?>">
                    </div>
                </div>
                <div class="row mb-3 mt-3 fs-4">
                ...
                <div class="row mb-3 fs-4">
                    ...
                    <div class="col-sm-6">
                        <input type="number" class="form-control" id="j_ser"
                            name="j_ser" placeholder="เกรดเฉลี่ย" value="<?php echo $j; ?>">
                    </div>
                </div>
                <div class="row mb-3 fs-4">
